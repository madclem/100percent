...
function Timeline() {
  ...
  })(["margin:0;position:relative;top:50%;left:-1px;width:2px;background-image:linear-gradient(to bottom,rgba(0,0,0,.4),rgba(0,0,0,.0));height:", "%;", ":hover &{background-image:linear-gradient(to bottom,rgb(1,58,81),26%,rgb(0,229,158));}", ""], function (propsS) {
...
//# sourceMappingURL=about.js.5218e839e2feeee31b5a.hot-update.js.map