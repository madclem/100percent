...
function Timeline() {
  ...
  })(["margin:0;position:relative;top:50%;left:-1px;width:1px;background-image:linear-gradient(to bottom,rgba(0,0,0,.2),26%,rgba(0,0,0,0,.2));height:", "%;", ":hover &{background-image:linear-gradient(to bottom,rgb(1,58,81),26%,rgb(0,229,158));}", ""], function (propsS) {
...
//# sourceMappingURL=about.js.11c298896b2ddb2df6e4.hot-update.js.map