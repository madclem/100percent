...
function Timeline() {
  ...
  })(["margin:0;position:relative;top:50%;left:-1px;width:1px;background-image:linear-gradient(to bottom,rgba(0,0,0,.4),rgba(0,0,0,.0));height:", "%;", ":hover &{background-image:linear-gradient(to bottom,rgb(1,58,81),26%,rgb(0,229,158));}", ""], function (propsS) {
...
//# sourceMappingURL=about.js.403a1706af1ca51bbe25.hot-update.js.map