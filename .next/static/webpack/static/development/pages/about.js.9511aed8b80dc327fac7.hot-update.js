...
function Timeline() {
  ...
  })(["::before{content:\"\";position:absolute;top:0px;left:0px;height:100%;width:100%;background-image:linear-gradient(rgb(223,229,231),rgb(223,229,231));opacity:1;transition:opacity 200ms ease-in 0s;}margin:0;position:relative;top:50%;left:-1px;width:1px;height:", "%;", ":hover &{background-image:linear-gradient(to bottom,rgb(1,58,81),26%,rgb(0,229,158));}", ""], function (propsS) {
...
//# sourceMappingURL=about.js.9511aed8b80dc327fac7.hot-update.js.map