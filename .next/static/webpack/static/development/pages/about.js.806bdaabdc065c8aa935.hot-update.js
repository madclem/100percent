...
function Timeline() {
  ...
  })(["height:100%;width:75px;background-color:red;border-right:1px dashed rgba(0,0,0,.2);position:relative;::before{content:\"\";position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:10;background:transparent;}"]);
  ...
  })(["margin:0;position:relative;top:50%;left:-1px;width:2px;height:5px;background-image:linear-gradient(to bottom,rgb(1,58,81),26%,rgb(0,229,158));height:", "%;", ""], function (propsS) {
...
//# sourceMappingURL=about.js.806bdaabdc065c8aa935.hot-update.js.map