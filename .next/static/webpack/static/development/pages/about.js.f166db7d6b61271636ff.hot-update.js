...
function Timeline() {
  ...
  })(["margin:0;position:relative;top:50%;left:-2px;width:2px;background-image:linear-gradient(to bottom,rgba(0,0,0,.4),rgba(0,0,0,.0));height:", "%;", ":hover &{background-image:linear-gradient(to bottom,rgb(1,58,81),26%,rgb(0,229,158));}", ""], function (propsS) {
...
//# sourceMappingURL=about.js.f166db7d6b61271636ff.hot-update.js.map