...
function Timeline() {
  ...
  })(["margin:0;position:relative;top:50%;left:-1px;width:1px;background-image:linear-gradient(to bottom,rgba(0,0,0,0),26%,rgba(0,0,0,.4));height:", "%;", ":hover &{background-image:linear-gradient(to bottom,rgb(1,58,81),26%,rgb(0,229,158));}", ""], function (propsS) {
    return propsS.height || 0;
  }, Column, function (propsS) {
    return propsS.translateY ? "\n        background-image: linear-gradient(to top, rgba(0,0,0,0), 26%, rgba(0, 0,0, .4));\n            transform: translateY(-100%);\n\n            ".concat(Column, ":hover & {\n                background-image: linear-gradient(to top, rgb(1, 58, 81), 26%, rgb(0, 229, 158));\n            }\n        ") : '';
  }); // background-image: linear-gradient(to top, rgb(1, 58, 81), 26%, rgb(0, 229, 158));
...
//# sourceMappingURL=about.js.9401c7b6d7ae8ffb338b.hot-update.js.map