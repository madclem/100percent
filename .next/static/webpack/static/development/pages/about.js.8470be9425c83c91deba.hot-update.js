...
function Timeline() {
  ...
  })(["height:100%;width:75px;border-right:1px dashed rgba(0,0,0,.2);position:relative;"]);
  ...
  })(["margin:0;position:relative;top:50%;left:-1px;width:1px;height:5px;background-image:linear-gradient(to bottom,rgb(0,0,0),26%,rgb(0,0,0));height:", "%;", ":hover &{background-image:linear-gradient(to bottom,rgb(1,58,81),26%,rgb(0,229,158));}", ""], function (propsS) {
...
//# sourceMappingURL=about.js.8470be9425c83c91deba.hot-update.js.map