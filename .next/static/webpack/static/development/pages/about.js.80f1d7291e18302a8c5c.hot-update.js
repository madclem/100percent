...
function Timeline() {
  ...
  })(["margin:0;position:relative;top:50%;left:-1px;width:2px;height:5px;background-image:linear-gradient(to bottom,rgb(1,58,81),26%,rgb(0,229,158));height:", "%;", " ", ":hover &{width:4px;}"], function (propsS) {
    return propsS.height || 0;
  }, function (propsS) {
    return propsS.translateY ? "\n            background-image: linear-gradient(to top, rgb(1, 58, 81), 26%, rgb(0, 229, 158));\n            transform: translateY(-100%);\n        " : '';
  }, Column); // background-image: linear-gradient(to top, rgb(1, 58, 81), 26%, rgb(0, 229, 158));
...
//# sourceMappingURL=about.js.80f1d7291e18302a8c5c.hot-update.js.map