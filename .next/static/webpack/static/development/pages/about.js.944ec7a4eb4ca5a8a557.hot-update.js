...
function Timeline() {
  ...
  })(["height:100%;width:75px;background-color:red;border-right:1px dashed black;position:relative;::before{content:\"\";position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:10;background:transparent;}"]);
  ...
  })(["width:225px;background-color:white;position:absolute;z-index:2;padding:10px;", " ", " h5{margin:0 0 10px 0;}p{margin:0;}"], function (propsS) {
  ...
  })(["margin:0;position:relative;top:300px;width:10px;height:10px;background-colorL black;"]); // background-image: linear-gradient(to top, rgb(1, 58, 81), 26%, rgb(0, 229, 158));
  ...
  function getColumn() {
    ...
    return data.map(function (d, index) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Column, {
        ...
        __self: this
      }, " ", year, " "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Text, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 132
        },
...
//# sourceMappingURL=about.js.944ec7a4eb4ca5a8a557.hot-update.js.map