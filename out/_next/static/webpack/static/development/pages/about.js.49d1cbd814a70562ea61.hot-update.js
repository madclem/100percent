...
function Timeline() {
  ...
  })(["width:", "px;height:", "px;background-color:rgb(0,0,0);border:1px solid white;border-radius:100%;position:absolute;top:calc(50% - ", "px);left:-", "px;", ""], widthCorner, widthCorner, widthCorner / 2, widthCorner / 2, utils_styles_media__WEBPACK_IMPORTED_MODULE_2__["default"].tablet(_templateObject5())); // background-image: linear-gradient(to top, rgb(1, 58, 81), 26%, rgb(0, 229, 158));
...
//# sourceMappingURL=about.js.49d1cbd814a70562ea61.hot-update.js.map