...
function Timeline() {
  ...
  })(["width:", "px;height:", "px;background-color:rgb(0,0,0);border-radius:100%;position:absolute;top:calc(50% - ", "px);", ""], widthCorner, widthCorner, widthCorner / 2, utils_styles_media__WEBPACK_IMPORTED_MODULE_2__["default"].tablet(_templateObject5())); // background-image: linear-gradient(to top, rgb(1, 58, 81), 26%, rgb(0, 229, 158));
...
//# sourceMappingURL=about.js.f4104bd2ce32fc5c84ee.hot-update.js.map