...
function Card(props) {
  ...
  })(["overlow:hidden;pointer-events:none;background-color:white;z-index:2;padding:10px;margin-bottom:10px;position:relative;", " h5{margin:0 0 10px 0;}p{margin:0;}"], utils_styles_media__WEBPACK_IMPORTED_MODULE_2__["default"].tablet(_templateObject(), function (propsS) {
  ...
  })(["width:", "px;height:", "px;background-color:rgba(255,255,255,1);", ":hover &{background-color:rgb(251,140,0);}border-radius:100%;position:absolute;top:calc(100% - ", "px);left:-", "px;", ""], widthCorner, widthCorner, _Column__WEBPACK_IMPORTED_MODULE_3__["default"], widthCorner / 2, widthCorner / 2, utils_styles_media__WEBPACK_IMPORTED_MODULE_2__["default"].tablet(_templateObject2(), function (propsS) {
...
//# sourceMappingURL=about.js.56ee2fc53a36017d5df3.hot-update.js.map