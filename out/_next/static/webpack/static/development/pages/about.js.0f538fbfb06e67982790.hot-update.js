...
function Card(props) {
  ...
  })(["overlow:hidden;pointer-events:none;background-color:white;z-index:2;", " h5{margin:0 0 10px 0;}p{margin:0;}"], utils_styles_media__WEBPACK_IMPORTED_MODULE_2__["default"].tablet(_templateObject(), function (propsS) {
  ...
  var Corner = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].i.withConfig({
  ...
  })(["width:", "px;height:", "px;border-radius:50%;background-color:#f6f6f6;", " ", " ", " ", ""], widthCorner, widthCorner, function (propsS) {
    ...
    return propsS.left ? "\n            float: left;\n            margin-left: -".concat(widthCorner / 2, "px;\n        ") : "";
  }, function (propsS) {
    return propsS.right ? "\n            float: right;\n            margin-right: -".concat(widthCorner / 2, "px;\n        ") : "";
  });
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Container, _extends({}, props, {
    ...
    __self: this
  }, props.children), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Corner, {
    bottom: true,
    right: true,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=about.js.0f538fbfb06e67982790.hot-update.js.map